...
function nameCheck(name){
  return name==='Steven' ? 'What is up Steven?' : name==='Byran'? 'Hey Brayn!' : 'Cool name, '+name;
}

let nameGreeting= nameCheck('Steven')
console.log(nameCheck('kacer'))
////////////////// PROBLEM 11 ////////////////////
/*
...
console.log(faveColorFinder('purple'))
...
function thatsOdd(num){
  return num%2===0 ? 'That is not odd' : 'That is odd indeed'
}
let oddChecker=thatsOdd(7)
console.log(thatsOdd(7))
////////////////// PROBLEM 14 ////////////////////
...
function bigOrSmall(arr){
  ...
  for (let i=0; i<arr.length; i++){
    ...
    //return answer[i]>100 ? answer.push('big') : answer.push('small')
  }
  return answer
}
...
function theEliminator(contestans, loser){
  for (let i=0; i<contestans.length; i++){
    //return contestans[i]===loser? contestans.splice(loser): contestans
    if(contestans[i]===loser){
